 ...
 * Date: 11.06.14
 */
public class P6HaPreparedStatementAddBatchDelegate implements Delegate {

    private final PersistentStatementInformation statementInformation;

    public P6HaPreparedStatementAddBatchDelegate(PersistentStatementInformation statementInformation) {
